...
begin
    ...
    # TODO: is OpenFOAM install broken?
    using NaturalSort
    using SumTypes
...
let
    ...
    # Valid for Re < 1000.0, else 0.424Re!
    dragcoef(Re) = 24 * (1 + (1/6) * Re^(2/3))
    ...
    sol1 = solve(prob; saveat=LinRange(tspan..., 100))

    prob = ODEProblem(freefall!, u0, tspan, (p..., :constant))
    sol2 = solve(prob; saveat=LinRange(tspan..., 100))
...
# ╔═╡ 69d86b14-5064-474e-85df-791007fe8bcf
md"""
## Creating cases
"""
...
function createcase(; casename, dragmodel, applygravity, particlesize, rho)
    ...
    dst = joinpath(@__DIR__, "runtime", casename)
...
manifest_format = "2.0"
project_hash = "60178bd34200c14ca2ecc208c801af7a582dc700"
...
[[deps.SumTypes]]
deps = ["MacroTools"]
git-tree-sha1 = "76f41a25affd44cd12e0f19012eddd468b32c6a3"
