...
View[0].Name = "Iso-values";
View[1].Name = "Iso-values (0.67)";
View[2].Name = "z = 0.2";
View[0].ShowScale = 0;
View[1].ShowScale = 0;

View[0].Light = 1;
View[0].IntervalsType = 1; // Check in GUI, this means Iso-values!
View[0].NbIso = 6;
View[0].SmoothNormals = 1;
View[1].IntervalsType = 2;  // Continuous map
