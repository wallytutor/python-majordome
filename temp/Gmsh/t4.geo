...
Point(3) = {-e3-r , h1   , 0, Lc2};
Point(4) = {-e3-r , h1+r , 0, Lc2};
Point(5) = {-e3   , h1+r , 0, Lc2};
Point(6) = {-e3   , h1+h2, 0, Lc1};
Point(7) = { e3   , h1+h2, 0, Lc1};
Point(8) = { e3   , h1+r , 0, Lc2};
Point(9) = { e3+r , h1+r , 0, Lc2};
Point(10)= { e3+r , h1   , 0, Lc2};
Point(11)= { e1+e2, h1   , 0, Lc1};
Point(12)= { e1+e2, 0    , 0, Lc1};
Point(13)= { e2   , 0    , 0, Lc1};
...
Point(18)= {-R2 , h1+h3   , 0, Lc2};
Point(19)= {-R2 , h1+h3+h4, 0, Lc2};
Point(20)= { 0  , h1+h3+h4, 0, Lc2};
Point(21)= { R2 , h1+h3+h4, 0, Lc2};
Point(22)= { R2 , h1+h3   , 0, Lc2};
Point(23)= { 0  , h1+h3   , 0, Lc2};
...
// Here we define a new circle arc, starting at point 14 and ending at point 16,
// with the circle's center being the point 15:
Circle(3) = {14, 15, 16};
...
// By not generating this it makes the actual hole!
// Plane Surface(22) = {21};
