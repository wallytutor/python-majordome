...
![Newton Cooling](media/newton_cooling.png){fig-alt="newton-cooling" fig-align="center" width=80%}
...
- [Julia Math](https://github.com/JuliaMath): several math-related packages. Most basic users coming from _spreadsheet hell_ might be interested in [Polynomials.jl](https://juliamath.github.io/Polynomials.jl/stable/) from this family.

- [JuliaMolsim](https://juliamolsim.github.io/): molecular simulation in Julia, from DFT to Molecular dynamics.

- [JuliaGeometry](https://github.com/JuliaGeometry): computational geometry (meshes, ray tracing) packages.
