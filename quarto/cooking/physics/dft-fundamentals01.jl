...
# ╔═╡ 584ec230-c76b-11f0-8d2b-095e0a2bdabc
begin
	...
	import AtomsIO
	import AtomsBuilder
	import PseudoPotentialData
	using CairoMakie
end

# ╔═╡ d530bf39-94f3-4d36-9a6e-2e53166cb309
md"""
# DFTK.jl basics
"""

# ╔═╡ 95638ffe-4c4a-43d9-b257-a27d7533aac3
md"""
This study notebook requires the [DFTK.jl](https://docs.dftk.org/stable/) package, as well as some [recommended packages](https://docs.dftk.org/stable/guide/installation/#Optional:-Recommended-packages) and others commonly used throughout its documentation; first run should take some minutes until everything is pre-compiled.
"""

# ╔═╡ 3776d480-d754-4716-90bc-8d5a69e7b7f2


# ╔═╡ d6b6e73b-6b2e-4acb-98d6-51d464c724ed


# ╔═╡ 1bcc60bd-72f4-4641-9d61-3591b3173c12


# ╔═╡ 584930c7-43e1-48a2-b37d-a2dcd68a1cd5
...
manifest_format = "2.0"
project_hash = "865d414ccca68223af57a1dfb604cc63e52895be"
...
[[deps.AtomsBuilder]]
deps = ["AtomsBase", "JSON", "LinearAlgebra", "Random", "StaticArrays", "Unitful"]
git-tree-sha1 = "d6e2bb3018a8a3a78570be02080ef63a52d5fda5"
...
git-tree-sha1 = "6d0c867c04516efc44ffb89fb35c9400a0af0747"
...
git-tree-sha1 = "9ab4547c100303d4208aba26a31586e7e321a9bf"
