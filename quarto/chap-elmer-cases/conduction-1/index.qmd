...
![2D heat flow](2d/heat-flow.png){fig-alt="2d-heat-flow" fig-align="center" width=80%}
...
![2D animation](2d/animation/animation.gif){fig-alt="2d-animation-animation" fig-align="center" width=80%}

The same was done for 3D equivalent case as illustrated next:

![3D animation](3d/animation/animation.gif){fig-alt="3d-animation-animation" fig-align="center" width=80%}
