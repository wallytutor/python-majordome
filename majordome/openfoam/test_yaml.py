...
class TestMajordomeFoamYaml(unittest.TestCase):
    """Test suite for OpenFOAM case conversion to/from YAML."""

    def test_foam_to_yaml_and_yaml_to_foam_roundtrip(self) -> None:
        """Test roundtrip conversion between OpenFOAM case directory and YAML."""
...
""",
    ...
    def test_foam_yaml_case_dictionary_operations(self) -> None:
        """Test FoamYamlCase dict item accessors and path lookup methods."""
        case = FoamYamlCase({"system": {"controlDict": {"application": "simpleFoam"}}})
        self.assertEqual(case["system"]["controlDict"]["application"], "simpleFoam")
        ...
        self.assertEqual(
            case.get("system/controlDict/nonExistentKey", default="defaultVal"),
            "defaultVal",
        )
